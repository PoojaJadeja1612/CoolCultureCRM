        ...
        <div class="card-header py-3">
            <div class="card-title">
                <form id="searchForm" action="{{ route('technicianSearch') }}" method="get">
                    @csrf
                    <div class="card card-custom" style="width: 313%;">
                        <div class="card-header py-3">
                            <div class="card-title">
                                <h3 class="card-label font-weight-bolder text-dark">Report</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#example').DataTable({
                ...
                "order": [
                    [1, "asc"]
                ] // Example: Sorting by the second column in ascending order
            });
            ...
            $('#exportButton').on('click', function() {
                ...
                var headers = ['Sr No', 'Technician Name', 'Customer Name', 'Address', 'Work', 'Remark',
                    'Quantity', 'Date'
                ]; // Define selected headers
