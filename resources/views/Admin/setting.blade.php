...
@section('page', 'Company Setting')
@section('content')
    <form id="setting_form" method="POST" action="{{ route('updateSetting') }}" enctype="multipart/form-data">
        @csrf
        <div class="card card-custom">
            <div class="card-header py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark">Company Setting</h3>
                    <span class="text-muted font-weight-bold font-size-sm mt-1">Update your company setting</span>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter phone number" name="companyPhone"
                            onkeypress="return isNumber(event)" value="{{ $setting->companyPhone }}" />
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <textarea class="form-control" rows="1" name="addressLine1" placeholder="Enter address line 1">{{ $setting->addressLine1 }}</textarea>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Address line 2<span class="text-danger">*</span></label>
                        <textarea class="form-control" rows="1" name="addressLine2" placeholder="Enter address line 2">{{ $setting->addressLine2 }}</textarea>
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Enter pincode" name="pincode"
                            onkeypress="return isPincode(event)" value="{{ $setting->pincode }}" />
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-4 logoColumn">
                        <div class="image-input image-input-outline" id="companySmallLogo">
                            ...
                            <div class="image-input-wrapper"
                                style="background-image: url({{ asset('Logo/' . $setting->companySmallLogo) }})">
                            </div>
                    ...
                    <div class="form-group col-md-4 logoColumn">
                        <div class="image-input image-input-outline" id="companyLogo">
                            ...
                            <div class="image-input-wrapper companyLogo"
                                style="background-image: url({{ asset('Logo/' . $setting->companyLogo) }})">
                            </div>
                    ...
                    <div class="form-group col-md-4 logoColumn">
                        <div class="image-input image-input-outline" id="companyFavicon">
                            <label>Favicon</label>
                            <div class="image-input-wrapper"
                                style="background-image: url({{ asset('Logo/' . $setting->companyFavicon) }})">
                            </div>
